...
| `.config/wezterm/`         | `~/.config/wezterm/`    | terminal config (previous daily driver, kept installed) |
| `.config/ghostty/`         | `~/.config/ghostty/`    | terminal config (daily driver on trial since 2026-09-13, ported from wezterm) |

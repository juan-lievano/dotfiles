...
__conda_setup="$('/Users/juanp.lievanok./miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/juanp.lievanok./miniconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/juanp.lievanok./miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/juanp.lievanok./miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
dotcheck() {
  ...
  while IFS= read -r rel; do
    ...
    case "$rel" in README.md|.gitignore|LICENSE|install.sh) continue;; esac
